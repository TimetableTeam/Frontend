...
export function Button({ children, variant = 'primary', icon, className = '', ...props }) {
  ...
  return (
    <button className={`inline-flex min-h-10 items-center justify-center gap-2 rounded-brand-sm border px-4 py-2 text-sm font-bold transition disabled:cursor-not-allowed disabled:opacity-50 ${variants[variant]} ${className}`} {...props}>
