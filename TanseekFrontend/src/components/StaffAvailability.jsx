...
export default function StaffAvailability() {
  ...
  return (
    <>
      <PageHeader eyebrow={t('Doctor / TA')} title={t('Teaching availability')} description={t('Mark when you can teach this term. Preferred windows are soft preferences; unavailable slots are treated as scheduling constraints.')} actions={<>{submission && <StatusBadge status={submission.state === 'CONFIRMED' ? 'confirmed' : 'draft'}>{submission.state === 'CONFIRMED' ? t('Confirmed') : t('Draft')}</StatusBadge>}</>} />
